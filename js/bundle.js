...
function calc() {
    ...
    function initLocalSettings(selector, activeSelector) {
    ...
    function getStaticInformation(selector, activeSelector) {
        const elements = document.querySelectorAll(selector);
...
function modal(triggerSelector, modalSelector, modalTimerId) {
    ...
    const modalTrig = document.querySelectorAll(triggerSelector),
          modal = document.querySelector(modalSelector);
      
    modalTrig.forEach(btn => {
...
window.addEventListener('DOMContentLoaded', function() {
    const modalTimer = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)('.modal', modalTimer), 50000);
    ...
    cards();
    calc();
    (0,_modules_forms__WEBPACK_IMPORTED_MODULE_1__["default"])("form", modalTimer);
    slider();
});
})();
